(function () {
    ...
    angular.module('cogtu.ad')
        .controller('advertisers_campaign_reportController', ['$scope', '$location', '$http', 'CONFIG', 'baseService',
            function ($scope, $location, $http, CONFIG, baseService) {
                ...
                $scope.reportDataLoad = function () {
                    ...
                    $http.get("/advertisers_campaign_report/getCampaignTable?proid=" + proid + "&camid=" + camid + "&date=" + date + "&currentPage=" + $scope.currentPage)
                ...
                $scope.chartDataLoad = function () {
                    ...
                    $http.get("/advertisers_campaign_report/getChartData?proid=" + proid + "&camid=" + camid + "&date=" + date)
                        .success(function (response) {
                ...
                $scope.reportExcelExport = function () {
                    ...
                    var url = "/advertisers_campaign_report/Excel?camid=" + camid + "&proid=" + proid + "&date=" + date;
                    window.location = url;
